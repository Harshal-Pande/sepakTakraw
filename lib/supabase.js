...
// Client-side client for components - always use mock for now
export const supabase = createMockClient();

// Server-side client for API routes - always use mock for now
...
export const getClient = () => {
	...
	const keyToUse =
		isServer && process.env.SUPABASE_SERVICE_ROLE_KEY ? process.env.SUPABASE_SERVICE_ROLE_KEY : process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY;
	return createSupabaseClient(process.env.NEXT_PUBLIC_SUPABASE_URL, keyToUse);
};
